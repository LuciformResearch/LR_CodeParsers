...
export class CLanguageParser extends BaseLanguageParser {
  ...
  private parser: CScopeExtractionParser;

  constructor() {
    super();
    this.parser = new CScopeExtractionParser();
  }
  ...
  private convertToUniversalScope(scope: ScopeInfo): UniversalScope {
    return {
      ...
      languageSpecific: { c: { modifiers: scope.modifiers, complexity: scope.complexity } }
    };
  }
